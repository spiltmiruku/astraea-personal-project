      ...
      <div className="wrap-all-planets">
        <section className="planet">
          ...
          <p className="desc">
            ...
            composed primarily of carbon dioxide. Mars has the largest dust
            storms in the solar system. They can last for months and cover the
            entire planet.
          </p>
          <h3 className="trivia">Trivia</h3>
          <p className="desc">
            NASA's Mars rover Opportunity (Oppy) got hit by a storm and it
            knocked the camera and wheels out, and her last words were "My
            battery is low and it is getting cold".
            <br />
            NASA tried to reach her for eight months, and as their final
            farewell, they played Billie Holiday's "I'll be seeting you".
          </p>
        </section>
